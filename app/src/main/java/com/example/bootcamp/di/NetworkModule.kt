...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideChunkerCollector(@ApplicationContext context: Context): com.chuckerteam.chucker.api.ChuckerCollector =
        ChuckerCollector(
            context = context,
    ...
    ): com.chuckerteam.chucker.api.ChuckerInterceptor = ChuckerInterceptor.Builder(context)
    ...
    ): CsrfInterceptor = CsrfInterceptor(tokenManager, retrofitProvider)
    ...
    @Provides
    @Singleton
    fun provideUserProfileService(retrofit: Retrofit): com.example.bootcamp.data.remote.api.UserProfileService =
        retrofit.create(com.example.bootcamp.data.remote.api.UserProfileService::class.java)

    /** Provides FCMApiService API interface for push notification management. */
    @Provides
    @Singleton
    fun provideFCMApiService(retrofit: Retrofit): com.example.bootcamp.data.remote.api.FCMApiService =
        retrofit.create(com.example.bootcamp.data.remote.api.FCMApiService::class.java)

    /** Provides UserProductService API interface. */
    @Provides
    @Singleton
    fun provideUserProductService(retrofit: Retrofit): com.example.bootcamp.data.remote.api.UserProductService =
        retrofit.create(com.example.bootcamp.data.remote.api.UserProductService::class.java)
}
